...
//import little.goose.home.databinding.FragmentHomeBinding
//import little.goose.home.utils.CalendarViewUtils
...
//            requireContext(),
//            little.goose.common.R.color.add_button
//        )
//    }
//
//    private var year = 0
...
//    }
//    private var listTransaction: List<little.goose.account.data.entities.Transaction> by Delegates.observable(
//        emptyList()
//    ) { _, _, newValue ->
...
//                little.goose.account.ui.transaction.TransactionActivity.openAdd(
...
//                    ContextCompat.getColor(requireContext(), little.goose.common.R.color.red_500)
//                } else {
//                    ContextCompat.getColor(requireContext(), little.goose.common.R.color.green_500)
//                }
//            )
...
//        binding.apply {
////            tvMonthDate.text = getString(
////                R.string.some_month_date, month.toString(), day.toString()
////            )
...
//                getMapOfCalendarScheme(year, month)
//            )
//        }
//    }
//
...
//                viewModel.getTransactionsByYearAndMonth(year, month).getMapDayMoney()
//            }
//
