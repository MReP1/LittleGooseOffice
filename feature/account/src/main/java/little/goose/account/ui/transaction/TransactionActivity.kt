...
class TransactionActivity : AppCompatActivity(),
    ...
    private fun initType() {
        val transaction: little.goose.account.data.entities.Transaction? = intent.parcelable(
            TRANSACTION
        )
        transaction?.let {
            viewModel.apply {
                ...
                when (it.type) {
                    EXPENSE -> {
                        listTransaction = listOf(
                            little.goose.account.data.entities.Transaction(
                                it.id, EXPENSE,
    ...
    inner class TransactionPagerAdapter(
        private val iconListList: List<List<little.goose.account.data.models.TransactionIcon>>
    ...
    interface OnIconClickListener {
        fun onIconClick(icon: little.goose.account.data.models.TransactionIcon)
    }
    ...
    inner class TransactionPagerHolder(private val binding: LayoutAddTransactionBinding) :
        ...
        fun bindIcon(iconList: List<little.goose.account.data.models.TransactionIcon>) {
    ...
    inner class IconRcvAdapter(
        private val iconList: List<little.goose.account.data.models.TransactionIcon>,
    ...
    inner class IconRcvHolder(private val binding: ItemIconCardBinding) :
        ...
        fun bindData(transactionIcon: little.goose.account.data.models.TransactionIcon) {
                        ...
                        if (it == transactionIcon.id) {
                            binding.iconCard.setCardBackgroundColor(
                                ContextCompat.getColor(
                                    ...
                                    little.goose.common.R.color.item_selected
                                )
                            )
                        } else {
                            binding.iconCard.setCardBackgroundColor(
                                ContextCompat.getColor(
                                    this@TransactionActivity,
                                    little.goose.common.R.color.primary_color
                                )
                            )
                        }
                    }
