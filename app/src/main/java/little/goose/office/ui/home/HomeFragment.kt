...
import little.goose.office.R
import little.goose.office.databinding.FragmentHomeBinding
import little.goose.office.logic.data.constant.ACCOUNT
import little.goose.office.logic.data.constant.KEY_MEMORIAL
import little.goose.office.logic.data.constant.MEMORIAL
import little.goose.office.logic.data.constant.SCHEDULE
import little.goose.office.utils.CalendarViewUtils
...
class HomeFragment : Fragment(R.layout.fragment_home) {
    ...
    private var listTransaction: List<little.goose.account.data.entities.Transaction> by Delegates.observable(emptyList()) { _, _, newValue ->
