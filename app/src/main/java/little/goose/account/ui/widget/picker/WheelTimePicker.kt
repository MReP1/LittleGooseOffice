...
import little.goose.account.ui.widget.picker.adapter.*
import little.goose.account.utils.DateTimeUtils
import little.goose.account.utils.setGone
import little.goose.account.utils.setVisible
import java.util.*
...
class WheelTimePicker @JvmOverloads constructor(
    ...
    private fun setType(type: Int) {
        when (type) {
            DATETIME -> {
                yearPicker.setVisible()
                tvYear.setVisible()
                minutePicker.setVisible()
                tvMonth.setVisible()
                dayPicker.setVisible()
                tvDay.setVisible()
                monthPicker.setVisible()
                tvMonth.setVisible()
                dayPicker.setVisible()
                tvDay.setVisible()
            }
